...
const testimonials = [
  {
    name: "Arjun, 19",
    text: "Started SIPs at ₹2K/month. FinTech showed me I can retire by 48 if I stay consistent!",
    stars: 5,
  },
  {
    name: "Priya, 23",
    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-32 px-4 flex flex-col items-center text-center overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed font-light">
            Tell us your salary, dreams, and goals. Our AI builds a personalized
            roadmap across{" "}
            <strong className="text-white">
              stocks, bonds, gold, and more
            </strong>
            .
          </p>
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold font-jakarta mb-4">
            ...
            <span className="gradient-text">build wealth early</span>
          </h2>
          <p className="text-slate-400 text-lg">
            Most teenagers don&#39;t know where to start. We make it simple.
          </p>
        </motion.div>

        <div className="grid md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <GlowCard key={f.title} className="group cursor-default">
              <div
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-transparent via-indigo-950/30 to-transparent">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-3 font-jakarta">
            ...
            <span className="gradient-text-emerald">lesser-known ones</span>
          </h2>
          <p className="text-slate-400 text-center text-sm mb-10">
            We recommend across 15+ asset classes, not just stocks and FDs.
          </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-transparent via-violet-950/20 to-transparent">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-10 font-jakarta">
            Loved by young investors
          </h2>
      ...
      <section className="py-24 px-4 text-center relative">
        ...
        >
          ...
          <p className="text-slate-400 mb-8">
            The earlier you start, the more compounding does the work. Don&#39;t
            wait.
          </p>
          <Link href="/signup">
            <motion.button
      ...
      <footer className="border-t border-white/5 py-8 px-4 text-center text-sm text-slate-600">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div>
            For educational purposes. Not SEBI-registered financial advice.
          </div>
